...
def test_supported_openai_models_include_gpt_5_5_and_gpt_5_6() -> None:
    ...
    assert [(model["id"], model["label"]) for model in openai_options] == [
        ...
        ("openai:openai/gpt-4o-mini", "GitHub Models GPT-4o mini"),
        ("openai:openai/gpt-4.1-nano", "GitHub Models GPT-4.1 nano"),
    ]
...
def test_github_models_showcase_models_have_non_reasoning_profile(model_id: str) -> None:
