...
| `docker` | `agent/integrations/docker.py` | Docker socket on the trusted app container, `SANDBOX_TYPE="docker"`, pinned `XLSLIBERATOR_SANDBOX_IMAGE` and optional digest |
