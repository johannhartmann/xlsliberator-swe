...
SPECIALIST_PROFILES: tuple[SpecialistProfile, ...] = (
    ...
    SpecialistProfile(
        ...
        tool_names=(
            "xlsliberator_runtime_formula_parse",
    ...
    SpecialistProfile(
        ...
        tool_names=(
            "xlsliberator_runtime_interact",
            "xlsliberator_runtime_screenshot",
            "xlsliberator_migration_check",
        ),
        writable_paths=(
    ...
    SpecialistProfile(
        ...
        tool_names=(
            "xlsliberator_runtime_execute",
            "xlsliberator_runtime_capabilities",
            "xlsliberator_migration_check",
        ),
        writable_paths=(
    ...
    SpecialistProfile(
        ...
        tool_names=(
            "xlsliberator_runtime_inspect",
            "xlsliberator_buildfarm_create_worktree",
            "xlsliberator_buildfarm_apply_patch",
            "xlsliberator_buildfarm_build",
            "xlsliberator_buildfarm_test",
            "xlsliberator_buildfarm_compare",
        ),
        writable_paths=(
    ...
    SpecialistProfile(
        ...
        tool_names=(
            "xlsliberator_xlsprobe_dossier",
            "xlsliberator_odstool",
            "xlsliberator_migration_check",
            "xlsliberator_corpus_register_failure",
        ),
        writable_paths=(
